...
echo "$0 contained an error" >&2
echo "Some arguments may have contained an error
argument 1: $1
argument 2: $2
argument 3: $3
argument 4: $4
...
function error-exit {
echo "$1 was invalid" >&2
exit 2
}
#This function displays help information if the user asks for it on the command line or gives us a bad command line
function displayhelp {
echo "--host obtains and displays the host information of the system"
echo "--domain obtains and displays the domain name of the system"
echo "--ipconfig obtains and displays the Ip configuration of the system"
echo "--os obtains and displays the information of the operating system"
echo "--cpu obtains and displays information of the Central Processing Unit on this system"
echo "--memory obtains and displays information of the memory on this system"
echo "--disk obtains and displays information regarding the disks on this system"
echo "--printer obtains and displays information regarding the printer that is being used by the system"
}
...
function cleanup {
rm /tmp/*info.$$
logger -t "basename $0" -i -p user.info -s "Cleaning up temporary files"
}
trap cleanup SIGINT
